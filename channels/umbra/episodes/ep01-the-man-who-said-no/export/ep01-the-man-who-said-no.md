...
**Channel:** umbra  ·  **Episode:** `ep01-the-man-who-said-no`

**Subject:** Stanislav Petrov and the 1983 Soviet nuclear false alarm at Serpukhov-15

**Target:** 5 min (~750 words)  ·  **Status:** storyboarded  ·  **Ending:** 2 — implicating turn (the system is still there, faster than us)

## Production summary
- **Chapters:** 20  ·  **Scenes:** 93  ·  **Runtime (storyboarded):** 5:07
- **Cast:** petrov, duty_officer, the_general, civilian
...
**Working title:** The Man Who Said No

**Subject:** On 26 September 1983, Soviet duty officer Stanislav Petrov judged a satellite
missile-attack warning to be a false alarm — and was right.

**Why it fits the DNA:** Pure "system whose goals are not aligned with human well-being."
A lone red figure overrules the black institutional machine. Intelligence + infrastructure
failure + the Cold War. Procedural, numerate, unresolved.

**Cold-open moment:** Just after midnight, 26 September 1983, a bunker south of Moscow —
a man pours tea from a steel thermos and sits down facing a wall of screens.

**The mechanism:** The Oko early-warning satellites mistake sunlight glinting off
high-altitude clouds for missile launches → the panel reads LAUNCH, then five inbound
warheads → launch-on-warning doctrine demands he report a confirmed attack up the chain →
he reports a malfunction instead → ground radar shows an empty sky → he was right.

**Ending type:** 2 — implicating turn. The same kind of system still sits in every nuclear
state, faster and more trusted than the human in the chair.

**Key numbers/specifics:** 26 Sept 1983; ~00:14; one then five missiles; ~23 minutes to
impact; KAL 007 shot down 3 weeks earlier killing 269; satellite system "Oko" (eye);
bunker "Serpukhov-15"; dies 2017; ~1,000 warheads in a counterstrike.
...
It's just after midnight, the 26th of September 1983. In a bunker south of Moscow, a man named Stanislav Petrov pours tea from a steel thermos and lowers himself into a chair facing a wall of screens. He isn't supposed to be here tonight. Someone else called in sick.

This is the story of how one man, in twenty-three minutes, decided whether the world would end.

The bunker is called Serpukhov-15. It is the brain of a system called Oko — Russian for "eye." Oko is a network of satellites that stare down at the United States, watching for the heat bloom of a launched missile. If America fires, Oko sees it first. Petrov's job is simple. Watch the screens. Trust the system. Report what it tells him.

The Cold War is at its lowest point in twenty years. Three weeks earlier, a Soviet fighter shot down a Korean passenger jet, killing 269 people. The Americans are running military exercises near Soviet borders. Both sides have their fingers near the button, and everyone is waiting for the other side to move first.

At fourteen minutes past midnight, the system moves.

A single word fills the main panel in red letters: LAUNCH. A siren begins to wail. The computer reports one intercontinental ballistic missile, fired from a base in the United States, climbing now, aimed at the Soviet Union.

Petrov has a protocol. He is to pick up the phone, call his superiors, and report a confirmed attack. From that call the chain runs upward in minutes — to the General Staff, to the men who can order a counterstrike of a thousand warheads. The doctrine is called launch on warning. You do not wait for the first bomb to land. You fire while the enemy's missiles are still in the air.

But Petrov hesitates.

Something about the picture is wrong. One missile. The Americans have thousands. A real first strike would be a wall of them, fired all at once, to destroy Soviet rockets before they ever left the ground. Nobody starts a nuclear war with a single shot. It makes no sense.

He has seconds. If the missile is real, it lands in about twenty minutes.

He picks up the phone and reports a system malfunction. A false alarm. He has no way to know if he is right.

Then the system reports a second missile. Then a third. A fourth. A fifth. The screen now reads five inbound warheads. The siren does not stop. Every protocol, every machine in the room, is telling him the attack is real and that he is burning the only minutes that matter.

Petrov holds. He reports it again as a malfunction. And then he sits, and he waits, and he watches the clock, knowing that if he is wrong, the first detonations will arrive in minutes, and he will have spent the last quiet moments of the world being stubborn.

The minutes pass.

Nothing happens. No flash. No call. The missiles that were never there never arrive. Ground radar — which can only see a missile once it crosses the horizon — shows an empty sky.

Petrov was right.

Later, the engineers find the cause. The Oko satellites had caught sunlight glinting off high clouds over the northern United States and read the reflection as the heat of a launch. A rare alignment of the sun, the satellites, and the autumn weather. The system did exactly what it was built to do. It just saw the wrong thing.

Petrov is not given a medal. A medal would mean admitting the system had failed. He is quietly reprimanded for a gap in his logbook during the incident — he was, he later said, holding a phone in one hand and an intercom in the other. He is reassigned. He takes early retirement. For ten years, no one outside that bunker knows his name.

He dies in 2017, in a small apartment outside Moscow, largely forgotten. The system he overruled was never the problem, his superiors maintained. The man was just doing his job.

But the system is still there. Some version of it sits in every nuclear state on Earth, scanning the sky, deciding in seconds what takes the rest of us a lifetime to understand. It is faster than us now. It is trusted more than us.

And the next time it sees something that isn't there, the man in the chair may decide to believe it.

---

**Word count:** ~770
**Ending type used:** 2 — implicating turn (last line 14 words; trims to "the man in the chair may decide to believe it." = 10 words for VO if needed)
...
> Pure white-void background. One figure per prompt. No environments, no facial features.
> Generate in Nano Banana Pro, `count: 4`, then save each best result as a Reference Element.

## Petrov — red protagonist ("The One")
**Role:** the duty officer who overrules the system.
**Prompt:**
```
Cinematic photorealistic 3D render, a single matte RED featureless mannequin with a smooth
eggshell head (no eyes, nose, mouth, ears, or hair), realistic human proportions, polished
matte red surface, wearing the simple silhouette of a Soviet air-defence officer's shirt
with plain epaulettes and a collar (kept entirely red, no insignia color), standing
upright, arms relaxed at sides, isolated on a pure white seamless void background, soft
contact shadow beneath, cinematic key light from above, subtle red rim glow, shallow depth
of field, volumetric light, cinematic color grade, Unreal Engine 5, octane render, 8K,
anamorphic lens, shot on ARRI Alexa, 2:3
```

## Duty Officer (System) — black institution ("The System")
**Role:** the interchangeable staff and the machine around Petrov.
**Prompt:**
```
Cinematic photorealistic 3D render, a single matte BLACK featureless mannequin with a
smooth eggshell head (no eyes, nose, mouth, ears, or hair), realistic human proportions,
polished matte black surface, wearing the plain silhouette of a Soviet military duty
uniform (kept entirely black, no insignia color), standing at attention, isolated on a
pure white seamless void background, soft contact shadow beneath, cinematic key light from
above, shallow depth of field, volumetric light, cinematic color grade, Unreal Engine 5,
octane render, 8K, anamorphic lens, shot on ARRI Alexa, 2:3
```

## The General — black body + photoreal uniform ("The Suits")
**Role:** high command — the authority the launch order would reach.
**Prompt:**
```
Cinematic photorealistic 3D render, a single matte BLACK featureless mannequin with a
smooth eggshell head (no eyes, nose, mouth, ears, or hair), realistic human proportions,
wearing a detailed photoreal Soviet general's dress uniform — olive tunic, gold shoulder
boards, red collar tabs, rows of medals — layered over the black mannequin body, standing
formally with hands clasped, isolated on a pure white seamless void background, soft
contact shadow beneath, cinematic key light from above, shallow depth of field, volumetric
light, cinematic color grade, Unreal Engine 5, octane render, 8K, anamorphic lens, shot on
ARRI Alexa, 2:3
```

## Civilian (The World) — glossy white ("The World")
**Role:** the sleeping city — the stakes.
**Prompt:**
```
Cinematic photorealistic 3D render, a single glossy white featureless mannequin with a
smooth eggshell head (no eyes, nose, mouth, ears, or hair), realistic human proportions,
polished plastic-white surface, in plain everyday clothing silhouette (kept white),
standing neutrally, isolated on a pure white seamless void background, soft contact shadow
beneath, cinematic key light from above, shallow depth of field, volumetric light,
...
> Red Petrov, black system, white world. Stark contrast, label tags + triangular pointers,
> minimal text. Generate in Nano Banana Pro, `count: 4` each.

## Variant 1 — "The One Who Refused"
- **Concept:** lone red mannequin at the console, black officers closing in behind, red LAUNCH wall.
- **Text overlay:** RED tag "SAID NO" (at red head) · BLACK tag "LAUNCH" (at the screen wall)
- **Emotion trigger:** isolation under pressure; the weight of one decision.
- **Composition note:** red figure right-of-center, black figures framing left, screen wall glowing red behind.
- **Prompt:**
```
Cinematic photorealistic 3D render thumbnail, a single matte red featureless mannequin (a
Soviet officer, eggshell head, no facial features) seated at a command console right of
center, three matte black featureless mannequins looming behind and closing in from the
left, a towering wall of screens glowing alarm-red filling the background, dim Soviet
bunker, stark high-contrast lighting, key from above, deep shadows, bold red / pure white /
deep black palette, shallow depth of field, volumetric light, cinematic color grade, Unreal
Engine 5, octane render, 8K, anamorphic lens, shot on ARRI Alexa, 16:9. Overlaid graphic
tags: a RED rectangular tag reading "SAID NO" with a small triangular pointer at the red
mannequin's head; a BLACK rectangular tag reading "LAUNCH" with a triangular pointer at the
glowing screen wall. Bold ALL-CAPS sans-serif, white text.
```

## Variant 2 — "23 Minutes"
- **Concept:** extreme isolation; red figure tiny under a vast red countdown wall.
- **Text overlay:** RED tag "23 MIN" (at red head) · BLACK tag "5 INBOUND" (at screen)
- **Emotion trigger:** the clock; impending catastrophe held by one person.
- **Composition note:** centered tiny red figure, enormous red screen wall, heavy negative space.
- **Prompt:**
```
Cinematic photorealistic 3D render thumbnail, a single tiny matte red featureless mannequin
seated alone and centered, dwarfed beneath an enormous wall of screens glowing alarm-red
showing five missile tracks, vast dark Soviet bunker, immense negative space, stark
high-contrast lighting, key from above, deep shadows, bold red / pure white / deep black
palette, shallow depth of field, volumetric light, cinematic color grade, Unreal Engine 5,
octane render, 8K, anamorphic lens, shot on ARRI Alexa, 16:9. Overlaid graphic tags: a RED
rectangular tag reading "23 MIN" with a triangular pointer at the red mannequin's head; a
BLACK rectangular tag reading "5 INBOUND" with a triangular pointer at the screen wall. Bold
ALL-CAPS sans-serif, white text.
```

## Variant 3 — "The False Alarm"
- **Concept:** the cause — sunlight glint over clouds, satellite POV, red figure inset.
- **Text overlay:** RED tag "WRONG?" (at red head) · BLACK tag "OKO" (at satellite)
- **Emotion trigger:** doubt; was the machine lying?
- **Composition note:** split tension — satellite-over-Earth dominant, small red figure lower-right.
- **Prompt:**
```
Cinematic photorealistic 3D render thumbnail, a Soviet early-warning satellite over a dark
curve of Earth at night with a bright sun-glint flaring off high clouds, dominant in frame;
in the lower right, small, a single matte red featureless mannequin seated at a console
looking up; deep black space, alarm-red accents, stark high-contrast lighting, bold red /
...
Overlaid graphic tags: a RED rectangular tag reading "WRONG?" with a triangular pointer at
the red mannequin's head; a BLACK rectangular tag reading "OKO" with a triangular pointer at
the satellite. Bold ALL-CAPS sans-serif, white/red text.
```

## Variant 4 — "Overruled"
- **Concept:** red hand refusing the red telephone; the protocol broken.
- **Text overlay:** RED tag "NO" (at the hand) · BLACK tag "PROTOCOL" (at the phone)
- **Emotion trigger:** defiance; the single act of refusal.
- **Composition note:** tight on red mannequin hand hovering over / pulling back from red phone.
- **Prompt:**
```
Cinematic photorealistic 3D render thumbnail, an extreme close-up of a matte red featureless
mannequin hand pulling back from a red Soviet telephone handset on a console, a printed
protocol checklist beneath it, alarm-red glow, dim bunker, stark high-contrast lighting,
deep shadows, bold red / pure white / deep black palette, shallow depth of field, volumetric
light, cinematic color grade, Unreal Engine 5, octane render, 8K, anamorphic lens, shot on
ARRI Alexa, 16:9. Overlaid graphic tags: a RED rectangular tag reading "NO" with a
triangular pointer at the red hand; a BLACK rectangular tag reading "PROTOCOL" with a
triangular pointer at the telephone. Bold ALL-CAPS sans-serif, white text.
```

## Variant 5 — "Forgotten"
- **Concept:** the implicating turn — the system endures, the man does not.
- **Text overlay:** RED tag "SAVED US ALL" (at red head) · BLACK tag "NO MEDAL" (at black figures)
- **Emotion trigger:** injustice; the quiet erasure.
- **Composition note:** red figure walking away small, black uniformed figures turned from it.
- **Prompt:**
```
Cinematic photorealistic 3D render thumbnail, a single matte red featureless mannequin
walking away small down a dim concrete corridor, a row of matte black featureless mannequins
in Soviet uniform standing turned away from it, cold institutional light, stark high-contrast
lighting, deep shadows, bold red / pure white / deep black palette, shallow depth of field,
volumetric light, cinematic color grade, Unreal Engine 5, octane render, 8K, anamorphic
lens, shot on ARRI Alexa, 16:9. Overlaid graphic tags: a RED rectangular tag reading "SAVED
US ALL" with a triangular pointer at the red mannequin's head; a BLACK rectangular tag
reading "NO MEDAL" with a triangular pointer at the black figures. Bold ALL-CAPS sans-serif,
white text.
```

---

Generate these in Nano Banana or GPT-image. Want to tweak any? Otherwise reply "next" to wrap.
